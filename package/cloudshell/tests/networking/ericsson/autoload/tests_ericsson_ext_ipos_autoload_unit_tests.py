...
from cloudshell.networking.ericsson.extended.ipos.autoload.ericsson_extended_ipos_snmp_autoload import \
    EricssonExtendedIPOSSNMPAutoload
...
class TestEricssonIPOSAutoload(TestCase):
    ...
    def test_is_loads_SSR8020_correctly(self):
        ...
        handler = EricssonExtendedIPOSSNMPAutoload(snmp_handler=snmp, cli=cli, logger=logger,
                                                   supported_os=["IP[ -]?OS"],
