...
import time
from cloudshell.networking.ericsson.extended.ipos.ericsson_extended_ipos_resource_driver import \
    EricssonIPOSExtendedResourceDriver
from cloudshell.shell.core.context import ResourceCommandContext, ResourceContextDetails, ReservationContextDetails

tt = EricssonIPOSExtendedResourceDriver()
...
context.resource.address = '192.168.73.70'
