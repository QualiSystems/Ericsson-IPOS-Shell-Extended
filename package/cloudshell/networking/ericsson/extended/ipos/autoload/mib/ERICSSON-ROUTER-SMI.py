...
# ASN.1 source file://C:\MIBS\text_mibs\ERICSSON-ROUTER-SMI.my
...
eriRouterSMI = ModuleIdentity((1, 3, 6, 1, 4, 1, 193, 218)).setRevisions(
    ("2015-01-14 18:00", "2011-01-19 18:00", "2002-06-06 00:00", "2001-06-27 00:00", "1998-04-18 23:00",))
...
mibBuilder.exportSymbols("ERICSSON-ROUTER-SMI", eriRouterMgmt=eriRouterMgmt, eriRouterSMI=eriRouterSMI,
                         eriRouterEntities=eriRouterEntities, eriRouterExperiment=eriRouterExperiment,
                         eriRouterProducts=eriRouterProducts, eriRouterCapabilities=eriRouterCapabilities,
                         PYSNMP_MODULE_ID=eriRouterSMI, eriRouterModules=eriRouterModules,
