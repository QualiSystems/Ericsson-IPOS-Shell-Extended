...
class EricssonExtendedIPOSSNMPAutoload(EricssonExtendedSNMPAutoload):
    def __init__(self, snmp_handler=None, logger=None, supported_os=None, cli=None, snmp_community=None):
        """Basic init with injected snmp handler and logger
            ...
            :return:
            """
        super(EricssonExtendedIPOSSNMPAutoload, self).__init__(snmp_handler, logger, supported_os)
    ...
    def load_ericsson_mib(self):
        ...
        mib_path = os.path.abspath(os.path.join(local_path, '', 'mib'))

        self.snmp.update_mib_sources(mib_path)

    def _load_configuration(self):
        local_path = os.path.dirname(__file__)
        self.configuration_file_path = os.path.abspath(os.path.join(local_path, '',
                                                                    'ericsson_ext_ipos_autoload_config.json'))
